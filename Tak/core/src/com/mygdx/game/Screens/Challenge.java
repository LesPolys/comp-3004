...
//launch challenge based on challenge select variable proabbaly use a switch here for it
                ...
                LightTriangle1 lightTrianglePiece1;
                DarkTrianglePiece1 darkTrianglePiece1;
                LightCirclePiece1 lightCirclePiece;
                DarkCirclePiece1 darkCirclePiece;
                ...
                switch(challengeSelect) {
                    ...
                    case 2:
                        ...
                        //1,2
                        i = 2;posX = 1;posY = 2;type = 0;player = true;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(220+(posX*30),110+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                    ...
                    case 3:
                        ...
                        lightSquarePiece1Dragable[i] = new Dragable(lightTrianglePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(220+(posX*30),110+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        lightSquarePiece1Dragable[i].toggleInPlay();
                        ...
                        //0,1 1
                        i = 0;posX = 0;posY = 1;type = 0;player = false;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(220+(posX*30),110+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //0,1 2
                        i = 1;posX = 0;posY = 1;type = 0;player = false;index=1;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(220+(posX*30),110+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //0,1 3
                        i = 2;posX = 0;posY = 1;type = 0;player = false;index=2;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(220+(posX*30),110+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //0,1 4
                        i = 3;posX = 0;posY = 1;type = 0;player = false;index=3;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(220+(posX*30),110+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //0,1 5
                        i = 4;posX = 0;posY = 1;type = 0;player = false;index=4;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(220+(posX*30),110+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //0,1 6
                        i = 5;posX = 0;posY = 1;type = 1;player = false;index=5;
                        darkSquarePiece1Dragable[i] = new Dragable(darkTrianglePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(220+(posX*30),110+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        darkSquarePiece1Dragable[i].toggleInPlay();
                        ...
                        //0,2
                        i = 1;posX = 0;posY = 2;type = 1;player = true;
                        lightSquarePiece1Dragable[i] = new Dragable(lightTrianglePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(220+(posX*30),110+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //1,0
                        i = 6;posX = 1;posY = 0;type = 0;player = false;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(220+(posX*30),110+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //1,2
                        i = 2;posX = 1;posY = 2;type = 1;player = true;
                        lightSquarePiece1Dragable[i] = new Dragable(lightTrianglePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(220+(posX*30),110+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //2,2
                        i = 7;posX = 2;posY = 2;type = 0;player = false;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(220+(posX*30),110+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //2,3
                        i = 8;posX = 2;posY = 3;type = 0;player = false;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(220+(posX*30),110+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //3,0
                        i = 3;posX = 3;posY = 0;type = 0;player = true;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(220+(posX*30),110+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //3,2
                        i = 4;posX = 3;posY = 2;type = 0;player = true;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(220+(posX*30),110+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //3,2
                        i = 5;posX = 3;posY = 3;type = 0;player = true;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(220+(posX*30),110+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //3,2
                        i = 6;posX = 3;posY = 3;type = 0;player = true;index = 1;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(220+(posX*30),110+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //3,2
                        i = 7;posX = 3;posY = 3;type = 0;player = true;index = 2;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(220+(posX*30),110+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //3,2
                        i = 8;posX = 3;posY = 3;type = 0;player = true;index = 3;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(220+(posX*30),110+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                    ...
                    case 4:
                        ...
                        //0,2 2
                        i = 1;posX = 0;posY = 2;type = 0;player = true;index = 1;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(220+(posX*30),110+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //1,1 1
                        i = 2;posX = 1;posY = 1;type = 0;player = true;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(220+(posX*30),110+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //1,1 2
                        i = 3;posX = 1;posY = 1;type = 0;player = true;index = 1;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(220+(posX*30),110+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //1,2
                        i = 1;posX = 1;posY = 2;type = 0;player = false;index =0;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(220+(posX*30),110+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //1,2
                        i = 4;posX = 1;posY = 2;type = 0;player = true;index = 1;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(220+(posX*30),110+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //2,0
                        i = 2;posX = 2;posY = 0;type = 0;player = false;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(220+(posX*30),110+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //2,1 1
                        i = 5;posX = 2;posY = 1;type = 0;player = true;index = 0;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(220+(posX*30),110+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //2,1 2
                        i = 3;posX = 2;posY = 1;type = 0;player = false;index = 1;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(220+(posX*30),110+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //2,2
                        i = 6;posX = 2;posY = 2;type = 0;player = true;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(220+(posX*30),110+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //2,3 1
                        i = 7;posX = 2;posY = 3;type = 0;player = true;index = 0;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(220+(posX*30),110+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //2,3 2
                        i = 4;posX = 2;posY = 3;type = 0;player = false;index = 1;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(220+(posX*30),110+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //3,1 1
                        i = 5;posX = 3;posY = 1;type = 0;player = false;index = 0;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(220+(posX*30),110+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //3,1 1
                        i = 6;posX = 3;posY = 1;type = 0;player = false;index = 1;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(220+(posX*30),110+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //3,1 1
                        i = 7;posX = 3;posY = 1;type = 0;player = false;index = 2;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(220+(posX*30),110+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                    ...
                    case 5:
                        ...
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        darkSquarePiece1Dragable[i].toggleInPlay();
                        challengeScreen.stage.addActor(darkSquarePiece1Dragable[i]);
                        challengeScreen.getGameBoard().setSquare(posX,posY,player,type,index);
                        ...
                        //0,3 1
                        i = 2;posX = 0;posY = 3;type = 0;player = false;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //0,3 2
                        i = 0;posX = 0;posY = 3;type = 1;player = true;index = 1;
                        lightSquarePiece1Dragable[i] = new Dragable(lightTrianglePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        lightSquarePiece1Dragable[i].toggleInPlay();
                        challengeScreen.stage.addActor(lightSquarePiece1Dragable[i]);
                        challengeScreen.getGameBoard().setSquare(posX,posY,player,type,index);
                        ...
                        //0,4 1
                        i = 3;posX = 0;posY = 4;type = 0;player = false;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //0,4 2
                        i = 4;posX = 0;posY = 4;type = 0;player = false;index = 1;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //0,4 3
                        i = 5;posX = 0;posY = 4;type = 0;player = false;index = 2;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //0,4 4
                        i = 6;posX = 0;posY = 4;type = 1;player = false;index = 3;
                        darkSquarePiece1Dragable[i] = new Dragable(darkTrianglePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //1, 3
                        i = 7;posX = 1;posY = 3;type = 0;player = false;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //1,4 1
                        i = 1;posX = 1;posY = 4;type = 0;player = true;index = 0;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //1, 4 2
                        i = 8;posX = 1;posY = 4;type = 0;player = false;index = 1;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //2, 1
                        i = 9;posX = 2;posY = 1;type = 1;player = false;
                        darkSquarePiece1Dragable[i] = new Dragable(darkTrianglePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //2, 4 1
                        i = 2;posX = 2;posY = 4;type = 0;player = true;index = 0;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //2, 4 2
                        i = 10;posX = 2;posY = 4;type = 0;player = false;index = 1;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //3, 0 2
                        i = 4;posX = 3;posY = 0;type = 0;player = true;index = 1;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //3, 1
                        i = 5;posX = 3;posY = 1;type = 0;player = true;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //3, 4
                        i = 7;posX = 3;posY = 4;type = 0;player = true;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //4, 1
                        i = 8;posX = 4;posY = 1;type = 1;player = true;
                        lightSquarePiece1Dragable[i] = new Dragable(lightTrianglePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //4, 2 1
                        i = 9;posX = 4;posY = 2;type = 0;player = true;index = 0;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //4, 2 2
                        i = 10;posX = 4;posY = 2;type = 0;player = true;index = 1;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //4, 2 3
                        i = 11;posX = 4;posY = 2;type = 0;player = true;index = 2;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //4, 2 4
                        i = 12;posX = 4;posY = 2;type = 0;player = true;index = 3;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //4, 2 5
                        i = 11;posX = 4;posY = 2;type = 0;player = false;index = 4;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //4, 2 6
                        i = 12;posX = 4;posY = 2;type = 0;player = false;index = 5;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //4, 3
                        i = 13;posX = 4;posY = 3;type = 0;player = true;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //4, 4
                        i = 13;posX = 4;posY = 4;type = 1;player = false;
                        darkSquarePiece1Dragable[i] = new Dragable(darkTrianglePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                    ...
                    case 6:
                        ...
                        //0, 3
                        i = 1;posX = 0;posY = 3;type = 0;player = true;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //0, 3
                        i = 0;posX = 0;posY = 3;type = 0;player = false;index = 1;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //1, 0 1
                        i = 1;posX = 1;posY = 0;type = 0;player = false;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //1, 0 2
                        i = 2;posX = 1;posY = 0;type = 0;player = true;index = 1;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //1, 0 3
                        i = 3;posX = 1;posY = 0;type = 0;player = true;index = 2;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //1, 0 4
                        i = 4;posX = 1;posY = 0;type = 0;player = true;index = 3;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //1, 0 5
                        i = 2;posX = 1;posY = 0;type = 0;player = false;index = 4;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //1, 0 6
                        i = 3;posX = 1;posY = 0;type = 2;player = false;index = 5;
                        darkSquarePiece1Dragable[i] = new Dragable(darkCirclePiece.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        darkSquarePiece1Dragable[i].toggleInPlay();
                        ...
                        //1, 1
                        i = 5;posX = 1;posY = 1;type = 0;player = true;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //1, 2
                        i = 6;posX = 1;posY = 2;type = 0;player = true;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //1, 2
                        i = 7;posX = 1;posY = 2;type = 0;player = true;index = 1;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //1, 3
                        i = 8;posX = 1;posY = 3;type = 1;player = true;
                        lightSquarePiece1Dragable[i] = new Dragable(lightTrianglePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //1, 4
                        i = 9;posX = 1;posY = 4;type = 0;player = true;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //1, 4 6
                        i = 4;posX = 1;posY = 4;type = 0;player = false;index = 1;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //1, 4 6
                        i = 5;posX = 1;posY = 4;type = 0;player = false;index = 2;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //1, 4 6
                        i = 6;posX = 1;posY = 4;type = 0;player = false;index = 3;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //1, 4 6
                        i = 7;posX = 1;posY = 4;type = 0;player = false;index = 4;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //2, 0
                        i = 10;posX = 2;posY = 0;type = 0;player = true;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //2, 1
                        i = 11;posX = 2;posY = 1;type = 0;player = true;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //2, 2
                        i = 8;posX = 2;posY = 2;type = 0;player = false;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //2, 3
                        i = 9;posX = 2;posY = 3;type = 1;player = false;
                        darkSquarePiece1Dragable[i] = new Dragable(darkTrianglePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //3, 0
                        i = 10;posX = 3;posY = 0;type = 0;player = false;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //3, 1 1
                        i = 12;posX = 3;posY = 1;type = 0;player = true;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //3, 1 2
                        i = 13;posX = 3;posY = 1;type = 0;player = true;index = 1;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //3, 2 1
                        i = 11;posX = 3;posY = 2;type = 0;player = false;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //3, 2 2
                        i = 12;posX = 3;posY = 2;type = 0;player = false;index = 1;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //3, 3
                        i = 14;posX = 3;posY = 3;type = 0;player = true;index = 1;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //3, 4
                        i = 13;posX = 3;posY = 4;type = 0;player = false;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //4,1
                        i = 15;posX = 4;posY = 1;type = 0;player = true;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //4, 1
                        i = 14;posX = 4;posY = 1;type = 0;player = false;index = 1;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //4, 2
                        i = 15;posX = 4;posY = 2;type = 0;player = false;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //4, 3
                        i = 16;posX = 4;posY = 3;type = 0;player = false;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //4, 3
                        i = 17;posX = 4;posY = 3;type = 0;player = false;index = 1;
                        darkSquarePiece1Dragable[i] = new Dragable(darkSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        darkSquarePiece1Dragable[i].setGridPos(posX, posY);
                        darkSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        darkSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //4,3
                        i = 16;posX = 4;posY = 3;type = 0;player = true;index = 2;
                        lightSquarePiece1Dragable[i] = new Dragable(lightSquarePiece1.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        ...
                        //4,3
                        i = 17;posX = 4;posY = 3;type = 2;player = true;index = 3;
                        lightSquarePiece1Dragable[i] = new Dragable(lightCirclePiece.getGamePiece(),index ,challengeScreen, challengeScreen.getGameBoard(), bsize, player, type,app);
                        lightSquarePiece1Dragable[i].setGridPos(posX, posY);
                        lightSquarePiece1Dragable[i].setBounds(205+(posX*30),95+(posY*30),30,30);
                        lightSquarePiece1Dragable[i].makeDraggable();
                        lightSquarePiece1Dragable[i].toggleInPlay();
