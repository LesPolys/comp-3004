...
// --------------------------------------------BLACK PIECES--------------------------------------------------//
        ...
        stackSkin[7].add("roadUnselectedBlack", new Texture("stackMenu/darkSquare1.png"));//road unselected
        stackSkin[8].add("roadSelectedBlack", new Texture("stackMenu/darkSquare2.png"));//road selected

        stackSkin[9].add("wallUnselectedBlack", new Texture("stackMenu/darkTriangle1.png"));//wall unselected
        stackSkin[10].add("wallSelectedBlack", new Texture("stackMenu/darkTriangle2.png"));//wall selected

        stackSkin[11].add("capUnselectedBlack", new Texture("stackMenu/darkCircle1.png"));//capstone unselected
        stackSkin[12].add("capSelectedBlack", new Texture("stackMenu/darkCircle2.png"));//capstone selected

// ----------------------------------------------------------------------------------------------------------//
        stackSkin[13].add("upButtonPressed", new Texture("stackMenu/upButtonPressed.png"));//upButton UnPressed
        stackSkin[14].add("upButtonUnpressed", new Texture("stackMenu/upButtonUnpressed.png"));//upButton Pressed

        stackSkin[15].add("downButtonUnpressed", new Texture("stackMenu/downButtonUnpressed.png"));//downButton UnPressed
        stackSkin[16].add("downButtonPressed", new Texture("stackMenu/downButtonPressed.png"));//downButton Pressed

        stackSkin[17].add("selectButtonUnpressed", new Texture("stackMenu/selectButtonUnpressed.png"));//selectButton UnPressed
        stackSkin[18].add("selectButtonPressed", new Texture("stackMenu/selectButtonPressed.png"));//selectButton Pressed
    ...
    public void initVersusAIScreen()
    {
        ...
        versusAISkin[21].add("difficultyOneUnpressed", new Texture(Gdx.files.internal("versusAI/BlankButton.png")));
        versusAISkin[22].add("difficultyOnePressed", new Texture(Gdx.files.internal("versusAI/BlankButton.png")));
        versusAISkin[23].add("difficultyTwoUnpressed", new Texture(Gdx.files.internal("versusAI/BlankButton.png")));
        versusAISkin[24].add("difficultyTwoPressed", new Texture(Gdx.files.internal("versusAI/BlankButton.png")));
